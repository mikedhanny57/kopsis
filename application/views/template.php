  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="<?=base_url('index.php/buku/toko')?>" class="logo"><b>K O P S I S</b></a>
            <!--logo end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="mt">
                      <a <?php if($konten=='toko'){echo 'class="active"';} ?> href="<?=base_url('index.php/buku/toko')?>">
                  ...
                  <li class="sub-menu">
                      <a <?php if($konten=='v_buku'){echo 'class="active"';} ?> href="<?=base_url('index.php/buku')?>" >
                  ...
                  <li class="sub-menu">
                      <a <?php if($konten=='v_kategori'){echo 'class="active"';} ?> href="javascript:;" >
                          <i class="fa fa-book"></i>
                          <span>Pustaka Barang</span>
                      </a>
                      <ul class="sub">
                          <li><a  href="<?=base_url('index.php/Buku')?>">Daftar Barang</a></li>
                          <li><a  href="<?=base_url('index.php/Kategori')?>">Kategori</a></li>
                      </ul>
                  </li>
                  <?php elseif($this->session->userdata('level')=="kasir"):?>
                  <li class="sub-menu">
                      <a <?php if($konten=='v_transaksi'){echo 'class="active"';} ?> href="<?=base_url('index.php/Transaksi')?>" >
                  ...
                  <?php endif?>
                  <li class="sub-menu">
                      <a <?php if($konten=='v_pesanan'){echo 'class="active"';} ?> href="<?=base_url('index.php/pesanan')?>" >
