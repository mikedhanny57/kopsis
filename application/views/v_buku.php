...
<table id="example" class="table table-hover table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?= $buku->nama_alat ?></td>
      <td><?= $buku->nama_kategori ?></td>
      <td><?= $buku->harga ?></td>
      <td><?= $buku->stok ?></td>
      <td><a href="#edit" onclick="edit('<?= $buku->id_alat ?>')" data-toggle="modal" class="btn btn-success">Ubah</a>
        <a href="<?=base_url('index.php/buku/hapus/'.$buku->id_alat)?>" onclick="return confirm('Are you sure?')" class="btn btn-danger">Hapus</a></td>
    </tr>
  <?php endforeach ?>
  </tbody>
</table>
      ...
      <div class="modal-body">
        <form action="<?=base_url('index.php/buku/tambah')?>" method="post" enctype="multipart/form-data">
          <table>
            ...
            <tr>
              <td>Nama Alat</td>
              <td><input type="text" name="nama_alat" required class="form-control"></td>
            </tr>
            <tr>
              <td>Kategori</td>
      ...
      <div class="modal-body">
        ...
        <input type="hidden" name="id_buku_lama" id="id_buku_lama">
          <table>
            ...
            <tr>
              <td>Nama Alat</td>
              <td><input type="text" name="nama_alat" id="nama_alat" required class="form-control"></td>
            </tr>
            <tr>
              <td>Kategori</td>
